    ...
    <div className='w-full flex justify-center mt-44'>
          ...
          <div>
            <div className="grid grid-cols-2 gap-8 md:gap-8">
              <div>
                <div className='mb-6'>
                  <div className='flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="12px" width="12px" version="1.1" id="Layer_1" viewBox="0 0 511.639 511.639" xml:space="preserve">
                      <g>
                        <g>
                    ...
                    <p className="text-gray-700" style={{ marginLeft: '5px' }}>Phone:</p>
                  </div>
                  <div className='flex items-center'>
                ...
                <div>
                  <div className='flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="20px" height="20px" viewBox="0 0 32 32"><path d="M25.497 6.503l.001-.003-.004.005L3.5 15.901l11.112 1.489 1.487 11.11 9.396-21.992.005-.006z" /></svg>
                    <p className="text-gray-700" style={{ marginLeft: '5px' }}>Location:</p>
                  </div>
                  <div className='flex items-center'>
              ...
              <div>
                <div className='mb-10'>
                  <div className='flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="12px" width="12px" version="1.1" id="Icons" viewBox="0 0 32 32" xml:space="preserve">
                    ...
                    <p className="text-gray-700" style={{ marginLeft: '5px' }}>Email:</p>
                  </div>
                  <div className='flex items-center'>
                ...
                <div >
                  <div className='flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 24 24" fill="none">
                      <path d="M15.4306 7.70172C7.55045 7.99826 3.43929 15.232 2.17021 19.3956C2.07701 19.7014 2.31139 20 2.63107 20C2.82491 20 3.0008 19.8828 3.08334 19.7074C6.04179 13.4211 12.7066 12.3152 15.514 12.5639C15.7583 12.5856 15.9333 12.7956 15.9333 13.0409V15.1247C15.9333 15.5667 16.4648 15.7913 16.7818 15.4833L20.6976 11.6784C20.8723 11.5087 20.8993 11.2378 20.7615 11.037L16.8456 5.32965C16.5677 4.92457 15.9333 5.12126 15.9333 5.61253V7.19231C15.9333 7.46845 15.7065 7.69133 15.4306 7.70172Z" fill="#000000" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <p className="text-gray-700" style={{ marginLeft: '5px' }}>Social Media:</p>
                  </div>
                  <div>
                    <p className="text-gray-900">info@tastybites.co</p>
                    <p className="text-gray-900">info@tastybites.co</p>
      ...
      <div className='bg-purple-700 border-gray-500 shadow-md max-h-fit max-w-96 rounded-xl  ml-10'>
        <div>
          <div className="p-5">
            <div className=''>
              <label className='text-white text-2xl font-bold'>Get In Touch</label>
            </div>
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              <div className='flex justify-between mb-4 gap-1 '>
                <TextField
                  ...
                  fullWidth
                  InputLabelProps={{ style: { color: 'white', fontSize: '10px', padding: '5px' } }}
              ...
              <div className="mb-4">
                <TextField
                  ...
                  InputLabelProps={{ style: { color: 'white', fontSize: '11px', padding: '10px' } }}
                />
              </div>
